...
do
    ...
    sleep 3
    ./$ftExeFile  --datadir ./datadir/$p2pPort --p2p_maxpeers 21 --p2p_listenaddr:$p2pPort --http_host 0.0.0.0  --p2p_bootnodes ./nodes.txt --http_port $httpPort --ws_port $wsPort --log_level 4 --http_api="miner,dpos,account,txpool,p2p,ft,keystore"  --miner_coinbase testtest5 --miner_private 8ee847ae5974a13ce9df66083e453ea1e0f7995379ed027a98e827aa8b6bc211 --miner_start > ./datadir/$p2pPort.log 2>&1 &
    echo "start node $i"
